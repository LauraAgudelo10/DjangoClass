...
class NosotrosPageView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ctx = super(NosotrosPageView, self).get_context_data(**kwargs)
        ctx['btn1'] = 'Inicio'
        ctx['btn2'] = 'Nosotros'
        ctx['btn3'] = 'Contacto'
        ctx['btn4'] = 'Presentación'
        ctx['txt1'] = '¡CONOCE A NUESTROS DESARROLLADORES!'
        ctx['txt2'] = 'Nosotros'
        ctx['txt3'] = 'SENA'
        ctx['txt4'] = 'Denisse Alejandra Alzate Meneses | Sergio León Saldarriaga Dávila | Laura Vanessa Agudelo Arias'
        return ctx
...
class PresentacionPageView(TemplateView):
    ...
    def get(self,request, *args, **kwargs):
        return render(request, self.template_name, {'btn1':'Inicio', 'btn2':'Nosotros', 'btn3':'Contacto', 'btn4': 'Presentación', 'txt1': '¡CONOCE MÁS ACERCA DE SAV!', 'tituloProblema1': 'PROBLEMA Y SOLUCIÓN','spanUno': '1','spanDos': '2', 'tituloProblema': 'PROBLEMA', 'texto1':'Actualmente en la parte administrativa del área de Contrato de Aprendizaje, ubicado en el Centro de Tecnología de la Manufactura Avanzada del SENA, no cuenta con un sistema que permita llevar un control más organizado de los registros y la documentación de los aprendices en cuanto a la alternativa escogida por los mismos para la realización de las prácticas.', 'tituloSolucion': 'SOLUCIÓN', 'texto2':'Debido a la problemática presentada en el área de Contrato de Aprendizaje, el equipo desarrollador decidió elaborar un sistema que ayudará a la organización, es por esto que se desarrollo SAV, un aplicativo web dirigido a los administradores del área de Contrato de Aprendizaje del Centro de la Manufactura Avanzada SENA, este brindará ayuda al área a tener una organización más adecuada de la información de cada aprendiz de acuerdo a la alternativa escogida por los mismos. ', 'tituloHerramientas':'HERRAMIENTAS UTILIZADAS PARA SU DESARROLLO','tituloDocumentos': 'Documentos SAV', 'txt2': 'SENA', 'txt3':'Denisse Alejandra Alzate Meneses | Sergio León Saldarriaga Dávila | Laura Vanessa Agudelo Arias' })
